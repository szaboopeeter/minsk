...
namespace Minsk.Tests.CodeAnalysis
{
    public class EvaluationTests
    {
        ...
        [InlineData("{var a=0 if a == 20 a=10 return a}", 0)]
        [InlineData("{var a=0 if a == 0 a=10 else a=5 return a}", 10)]
        [InlineData("{var a=0 if a == 20 a=10 else a = 5 return a}", 5)]
        ...
        [InlineData("{ var i = 0 while i < 5 { i = i + 1 if i == 3 break } return i }", 3)]
        [InlineData("{ var i = 0 do { i = i + 1 if i == 3 break } while i < 5 return i }", 3)]
        ...
        public void Evaluator_InvokeFunctionArguments_Missing()
        {
            ...
            var diagnostics = @"
                Function 'print' requires 1 arguments, but it was given 0.
            ";
        ...
        public void Evaluator_InvokeFunctionArguments_Exceeding()
        {
            ...
            var diagnostics = @"
                Function 'print' requires 1 arguments, but it was given 3.
            ";
